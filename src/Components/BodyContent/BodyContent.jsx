...
function BodyContent() {
  ...
  return (
    <Container fluid className="border-0 mt-5  rounded bg-light">
      <Row className="align-items-center">
        <Col xs={12} md={6} mb={3} mb-md={0}>
          <img
            src={photo}
            alt="Your Image"
            className="img-fluid mx-auto d-block ms-md-4 mt-5 ms-lg-3 ps-lg-5 mb-sm-5 mb-4"
            style={{ maxWidth: '100%', height: 'auto' }}
          />
        </Col>
  
        <Col xs={12} md={6} className="bg-light">
          <Card className="h-100 border-0 bg-light me-lg-5 mt-lg-4 " style={{ boxShadow: 'none', padding: 0 }}>
            <Card.Body className="text-center mt-lg-5">
